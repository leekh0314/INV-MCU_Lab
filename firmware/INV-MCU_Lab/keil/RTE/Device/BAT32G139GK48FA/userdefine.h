...
*          This file will be copied from the pack install forder to the path [mdk project folder]\RTE\Device\[BATxxxxx].
*          Please make sure to backup the modified setting before deleting the RTE folder!
* @version 1.0.0
* @date    2019/12/24
***********************************************************************************************************************/
#ifndef _USER_DEF_H
